...
import pytest
from glue_ar.common.shapes import cone_points, cone_triangles, cylinder_points, cylinder_triangles, rectangular_prism_points, rectangular_prism_triangulation, sphere_points, sphere_triangles
