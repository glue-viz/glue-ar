...
class GLTFBuilder:
    ...
    def build_model(self) -> GLTFModel:
        ...
        required_extensions = [ext for ext, params in self.extensions.items() if params.get("required", True)]
        used_extensions = [ext for ext, params in self.extensions.items() if params.get("used", True)]
        model_params = {
