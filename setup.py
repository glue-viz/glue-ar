...
"""
This file contains content originating from the 'jupyter-packaging' package, and
        ...
        def run(self):
            ...
            if not which(npm_cmd[0]):
                log.error(
                    ...
                    "using sudo, make sure `{0}` is availble to sudo".format(npm_cmd[0])
                )
                return
...
setup_args = dict(
    ...
    package_data={
        "glue_ar": ["py.typed", "resources/**", "**/*.vue"],
    },
